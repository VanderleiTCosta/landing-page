...
export default function LimpaFossaEmCapaoRedondo() {
  const bairro = "Capão Redondo";
  const zona = "Zona Sul";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Capão Redondo";
  const keywordEm = "Limpa Fossa em Capão Redondo";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-capao-redondo";
