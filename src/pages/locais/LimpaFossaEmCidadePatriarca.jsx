...
export default function LimpaFossaEmCidadePatriarca() {
  const bairro = "Cidade Patriarca";
  const zona = "Zona Leste";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Cidade Patriarca";
  const keywordEm = "Limpa Fossa em Cidade Patriarca";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-cidade-patriarca";
