...
export default function DesentupidoraEmAltoDaBoaVista() {
  const bairro = "Alto da Boa Vista";
  const zona = "Zona Sul";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Alto da Boa Vista";
  const keywordEm = "Desentupidora em Alto da Boa Vista";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-alto-da-boa-vista";
