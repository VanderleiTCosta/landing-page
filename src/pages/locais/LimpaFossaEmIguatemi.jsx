...
export default function LimpaFossaEmIguatemi() {
  const bairro = "Iguatemi";
  const zona = "Zona Leste";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Iguatemi";
  const keywordEm = "Limpa Fossa em Iguatemi";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-iguatemi";
