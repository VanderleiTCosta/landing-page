...
export default function HidrojateamentoEmSantana() {
  const bairro = "Santana";
  const zona = "Zona Norte";
  const servico = "Hidrojateamento";
  
  const tituloPagina = "Hidrojateamento Santana";
  const keywordEm = "Hidrojateamento em Santana";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/hidrojateamento-em-santana";
