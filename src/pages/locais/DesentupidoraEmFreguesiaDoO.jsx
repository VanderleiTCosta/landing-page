...
export default function DesentupidoraEmFreguesiaDoO() {
  const bairro = "Freguesia do Ó";
  const zona = "Zona Norte";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Freguesia do Ó";
  const keywordEm = "Desentupidora em Freguesia do Ó";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-freguesia-do-o";
