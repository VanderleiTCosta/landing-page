...
export default function EncanadorEmItaquera() {
  const bairro = "Itaquera";
  const zona = "Zona Leste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Itaquera";
  const keywordEm = "Encanador em Itaquera";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-itaquera";
