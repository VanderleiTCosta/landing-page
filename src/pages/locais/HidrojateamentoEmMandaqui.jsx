...
export default function HidrojateamentoEmMandaqui() {
  const bairro = "Mandaqui";
  const zona = "Zona Norte";
  const servico = "Hidrojateamento";
  
  const tituloPagina = "Hidrojateamento Mandaqui";
  const keywordEm = "Hidrojateamento em Mandaqui";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/hidrojateamento-em-mandaqui";
