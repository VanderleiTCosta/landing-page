...
export default function EncanadorEmBelaVista() {
  const bairro = "Bela Vista";
  const zona = "Centro de São Paulo";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Bela Vista";
  const keywordEm = "Encanador em Bela Vista";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-bela-vista";
