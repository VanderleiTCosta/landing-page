...
export default function EncanadorEmButanta() {
  const bairro = "Butantã";
  const zona = "Zona Oeste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Butantã";
  const keywordEm = "Encanador em Butantã";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-butanta";
