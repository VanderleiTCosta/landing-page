...
export default function DesentupidoraEmCidadeTiradentes() {
  const bairro = "Cidade Tiradentes";
  const zona = "Zona Leste";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Cidade Tiradentes";
  const keywordEm = "Desentupidora em Cidade Tiradentes";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-cidade-tiradentes";
