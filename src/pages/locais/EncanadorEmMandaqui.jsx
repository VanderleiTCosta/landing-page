...
export default function EncanadorEmMandaqui() {
  const bairro = "Mandaqui";
  const zona = "Zona Norte";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Mandaqui";
  const keywordEm = "Encanador em Mandaqui";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-mandaqui";
