...
export default function LimpaFossaEmCotia() {
  const bairro = "Cotia";
  const zona = "Zona Oeste";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Cotia";
  const keywordEm = "Limpa Fossa em Cotia";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-cotia";
