...
export default function EncanadorEmHortoFlorestal() {
  const bairro = "Horto Florestal";
  const zona = "Zona Norte";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Horto Florestal";
  const keywordEm = "Encanador em Horto Florestal";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-horto-florestal";
