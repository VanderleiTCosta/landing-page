...
export default function LimpaFossaEmJoseBonifacio() {
  const bairro = "José Bonifácio";
  const zona = "Zona Norte";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa José Bonifácio";
  const keywordEm = "Limpa Fossa em José Bonifácio";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-jose-bonifacio";
