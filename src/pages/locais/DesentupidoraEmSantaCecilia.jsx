...
export default function DesentupidoraEmSantaCecilia() {
  const bairro = "Santa Cecília";
  const zona = "Centro de São Paulo";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Santa Cecília";
  const keywordEm = "Desentupidora em Santa Cecília";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-santa-cecilia";
