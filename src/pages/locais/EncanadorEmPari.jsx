...
export default function EncanadorEmPari() {
  const bairro = "Pari";
  const zona = "Centro de São Paulo";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Pari";
  const keywordEm = "Encanador em Pari";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-pari";
