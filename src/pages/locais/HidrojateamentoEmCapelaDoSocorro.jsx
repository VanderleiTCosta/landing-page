...
export default function HidrojateamentoEmCapelaDoSocorro() {
  const bairro = "Capela do Socorro";
  const zona = "Zona Sul";
  const servico = "Hidrojateamento";
  
  const tituloPagina = "Hidrojateamento Capela do Socorro";
  const keywordEm = "Hidrojateamento em Capela do Socorro";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/hidrojateamento-em-capela-do-socorro";
