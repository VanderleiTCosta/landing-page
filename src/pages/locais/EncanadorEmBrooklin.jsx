...
export default function EncanadorEmBrooklin() {
  const bairro = "Brooklin";
  const zona = "Zona Sul";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Brooklin";
  const keywordEm = "Encanador em Brooklin";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-brooklin";
