...
export default function HidrojateamentoEmCaxingui() {
  const bairro = "Caxingui";
  const zona = "Zona Oeste";
  const servico = "Hidrojateamento";
  
  const tituloPagina = "Hidrojateamento Caxingui";
  const keywordEm = "Hidrojateamento em Caxingui";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/hidrojateamento-em-caxingui";
