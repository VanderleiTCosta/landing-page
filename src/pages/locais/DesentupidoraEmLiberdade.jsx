...
export default function DesentupidoraEmLiberdade() {
  const bairro = "Liberdade";
  const zona = "Centro de São Paulo";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Liberdade";
  const keywordEm = "Desentupidora em Liberdade";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-liberdade";
