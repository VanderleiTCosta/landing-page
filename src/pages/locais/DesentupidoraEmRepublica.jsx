...
export default function DesentupidoraEmRepublica() {
  const bairro = "República";
  const zona = "Centro de São Paulo";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora República";
  const keywordEm = "Desentupidora em República";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-republica";
