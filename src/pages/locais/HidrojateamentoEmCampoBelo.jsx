...
export default function HidrojateamentoEmCampoBelo() {
  const bairro = "Campo Belo";
  const zona = "Zona Sul";
  const servico = "Hidrojateamento";
  
  const tituloPagina = "Hidrojateamento Campo Belo";
  const keywordEm = "Hidrojateamento em Campo Belo";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/hidrojateamento-em-campo-belo";
