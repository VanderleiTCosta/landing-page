...
export default function EncanadorEmJaragua() {
  const bairro = "Jaraguá";
  const zona = "Zona Oeste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Jaraguá";
  const keywordEm = "Encanador em Jaraguá";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-jaragua";
