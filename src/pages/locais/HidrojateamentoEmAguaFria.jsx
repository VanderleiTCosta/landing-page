...
export default function HidrojateamentoEmAguaFria() {
  const bairro = "Água Fria";
  const zona = "Zona Norte";
  const servico = "Hidrojateamento";
  
  const tituloPagina = "Hidrojateamento Água Fria";
  const keywordEm = "Hidrojateamento em Água Fria";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/hidrojateamento-em-agua-fria";
