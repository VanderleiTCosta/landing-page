...
export default function HidrojateamentoEmCidadeTiradentes() {
  const bairro = "Cidade Tiradentes";
  const zona = "Zona Leste";
  const servico = "Hidrojateamento";
  
  const tituloPagina = "Hidrojateamento Cidade Tiradentes";
  const keywordEm = "Hidrojateamento em Cidade Tiradentes";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/hidrojateamento-em-cidade-tiradentes";
