...
export default function EncanadorEmCotia() {
  const bairro = "Cotia";
  const zona = "Zona Oeste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Cotia";
  const keywordEm = "Encanador em Cotia";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-cotia";
