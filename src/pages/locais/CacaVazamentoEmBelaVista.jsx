...
export default function CacaVazamentoEmBelaVista() {
  const bairro = "Bela Vista";
  const zona = "Centro de São Paulo";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento Bela Vista";
  const keywordEm = "Caça Vazamento em Bela Vista";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-bela-vista";
