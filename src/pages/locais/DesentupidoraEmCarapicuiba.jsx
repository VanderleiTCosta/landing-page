...
export default function DesentupidoraEmCarapicuiba() {
  const bairro = "Carapicuiba";
  const zona = "Zona Oeste";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Carapicuiba";
  const keywordEm = "Desentupidora em Carapicuiba";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-carapicuiba";
