...
export default function EncanadorEmSantaEfigenia() {
  const bairro = "Santa Efigênia";
  const zona = "Centro de São Paulo";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Santa Efigênia";
  const keywordEm = "Encanador em Santa Efigênia";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-santa-efigenia";
