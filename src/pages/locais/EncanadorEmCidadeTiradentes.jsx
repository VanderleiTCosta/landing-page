...
export default function EncanadorEmCidadeTiradentes() {
  const bairro = "Cidade Tiradentes";
  const zona = "Zona Leste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Cidade Tiradentes";
  const keywordEm = "Encanador em Cidade Tiradentes";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-cidade-tiradentes";
