...
export default function LimpaFossaEmConsolacao() {
  const bairro = "Consolação";
  const zona = "Centro de São Paulo";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Consolação";
  const keywordEm = "Limpa Fossa em Consolação";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-consolacao";
