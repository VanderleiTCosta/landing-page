...
export default function DesentupidoraEmCidadePatriarca() {
  const bairro = "Cidade Patriarca";
  const zona = "Zona Leste";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Cidade Patriarca";
  const keywordEm = "Desentupidora em Cidade Patriarca";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-cidade-patriarca";
