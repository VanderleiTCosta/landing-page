...
export default function DesentupidoraEmLauzanePaulista() {
  const bairro = "Lauzane Paulista";
  const zona = "Zona Norte";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Lauzane Paulista";
  const keywordEm = "Desentupidora em Lauzane Paulista";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-lauzane-paulista";
