...
export default function CacaVazamentoEmCangaiba() {
  const bairro = "Cangaiba";
  const zona = "Zona Leste";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento Cangaiba";
  const keywordEm = "Caça Vazamento em Cangaiba";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-cangaiba";
