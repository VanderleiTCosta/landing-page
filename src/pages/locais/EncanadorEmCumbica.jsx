...
export default function EncanadorEmCumbica() {
  const bairro = "Cumbica";
  const zona = "Outras Regiões";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Cumbica";
  const keywordEm = "Encanador em Cumbica";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-cumbica";
