...
export default function CacaVazamentoEmLauzanePaulista() {
  const bairro = "Lauzane Paulista";
  const zona = "Zona Norte";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento Lauzane Paulista";
  const keywordEm = "Caça Vazamento em Lauzane Paulista";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-lauzane-paulista";
