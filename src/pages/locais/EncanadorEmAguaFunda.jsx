...
export default function EncanadorEmAguaFunda() {
  const bairro = "Água Funda";
  const zona = "Zona Sul";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Água Funda";
  const keywordEm = "Encanador em Água Funda";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-agua-funda";
