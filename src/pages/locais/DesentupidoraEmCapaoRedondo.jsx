...
export default function DesentupidoraEmCapaoRedondo() {
  const bairro = "Capão Redondo";
  const zona = "Zona Sul";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Capão Redondo";
  const keywordEm = "Desentupidora em Capão Redondo";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-capao-redondo";
