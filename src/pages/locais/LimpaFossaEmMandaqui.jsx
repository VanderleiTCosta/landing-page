...
export default function LimpaFossaEmMandaqui() {
  const bairro = "Mandaqui";
  const zona = "Zona Norte";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Mandaqui";
  const keywordEm = "Limpa Fossa em Mandaqui";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-mandaqui";
