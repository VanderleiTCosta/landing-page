...
export default function DesentupidoraEmIguatemi() {
  const bairro = "Iguatemi";
  const zona = "Zona Leste";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Iguatemi";
  const keywordEm = "Desentupidora em Iguatemi";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-iguatemi";
