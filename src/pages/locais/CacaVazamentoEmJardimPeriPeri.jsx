...
export default function CacaVazamentoEmJardimPeriPeri() {
  const bairro = "Jardim Peri Peri";
  const zona = "Zona Norte";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento Jardim Peri Peri";
  const keywordEm = "Caça Vazamento em Jardim Peri Peri";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-jardim-peri-peri";
