...
export default function EncanadorEmBomRetiro() {
  const bairro = "Bom Retiro";
  const zona = "Centro de São Paulo";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Bom Retiro";
  const keywordEm = "Encanador em Bom Retiro";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-bom-retiro";
