...
export default function CacaVazamentoEmMandaqui() {
  const bairro = "Mandaqui";
  const zona = "Zona Norte";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento Mandaqui";
  const keywordEm = "Caça Vazamento em Mandaqui";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-mandaqui";
