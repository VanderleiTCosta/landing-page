...
export default function EncanadorEmAlphaville() {
  const bairro = "Alphaville";
  const zona = "Zona Oeste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Alphaville";
  const keywordEm = "Encanador em Alphaville";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-alphaville";
