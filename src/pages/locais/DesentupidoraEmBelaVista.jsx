...
export default function DesentupidoraEmBelaVista() {
  const bairro = "Bela Vista";
  const zona = "Centro de São Paulo";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Bela Vista";
  const keywordEm = "Desentupidora em Bela Vista";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-bela-vista";
