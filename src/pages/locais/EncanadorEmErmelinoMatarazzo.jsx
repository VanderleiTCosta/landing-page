...
export default function EncanadorEmErmelinoMatarazzo() {
  const bairro = "Ermelino Matarazzo";
  const zona = "Zona Leste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Ermelino Matarazzo";
  const keywordEm = "Encanador em Ermelino Matarazzo";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-ermelino-matarazzo";
