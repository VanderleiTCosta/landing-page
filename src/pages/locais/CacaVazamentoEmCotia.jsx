...
export default function CacaVazamentoEmCotia() {
  const bairro = "Cotia";
  const zona = "Zona Oeste";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento Cotia";
  const keywordEm = "Caça Vazamento em Cotia";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-cotia";
