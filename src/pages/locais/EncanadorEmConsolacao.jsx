...
export default function EncanadorEmConsolacao() {
  const bairro = "Consolação";
  const zona = "Centro de São Paulo";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Consolação";
  const keywordEm = "Encanador em Consolação";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-consolacao";
