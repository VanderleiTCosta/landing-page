...
export default function DesentupidoraEmJardimPeriPeri() {
  const bairro = "Jardim Peri Peri";
  const zona = "Zona Norte";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Jardim Peri Peri";
  const keywordEm = "Desentupidora em Jardim Peri Peri";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-jardim-peri-peri";
