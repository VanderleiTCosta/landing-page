...
export default function LimpaFossaEmBrooklin() {
  const bairro = "Brooklin";
  const zona = "Zona Sul";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Brooklin";
  const keywordEm = "Limpa Fossa em Brooklin";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-brooklin";
