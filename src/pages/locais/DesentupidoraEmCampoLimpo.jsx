...
export default function DesentupidoraEmCampoLimpo() {
  const bairro = "Campo Limpo";
  const zona = "Zona Sul";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Campo Limpo";
  const keywordEm = "Desentupidora em Campo Limpo";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-campo-limpo";
