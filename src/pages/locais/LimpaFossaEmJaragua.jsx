...
export default function LimpaFossaEmJaragua() {
  const bairro = "Jaraguá";
  const zona = "Zona Oeste";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Jaraguá";
  const keywordEm = "Limpa Fossa em Jaraguá";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-jaragua";
