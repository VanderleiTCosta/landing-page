...
export default function LimpaFossaEmCarapicuiba() {
  const bairro = "Carapicuiba";
  const zona = "Zona Oeste";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Carapicuiba";
  const keywordEm = "Limpa Fossa em Carapicuiba";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-carapicuiba";
