...
export default function EncanadorEmBragancaPaulista() {
  const bairro = "Bragança Paulista";
  const zona = "Outras Regiões";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Bragança Paulista";
  const keywordEm = "Encanador em Bragança Paulista";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-braganca-paulista";
