...
export default function EncanadorEmAltoDaBoaVista() {
  const bairro = "Alto da Boa Vista";
  const zona = "Zona Sul";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Alto da Boa Vista";
  const keywordEm = "Encanador em Alto da Boa Vista";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-alto-da-boa-vista";
