...
export default function CacaVazamentoEmGranjaViana() {
  const bairro = "Granja Viana";
  const zona = "Zona Oeste";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento Granja Viana";
  const keywordEm = "Caça Vazamento em Granja Viana";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-granja-viana";
