...
export default function DesentupidoraEmAmadorBueno() {
  const bairro = "Amador Bueno";
  const zona = "Zona Oeste";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Amador Bueno";
  const keywordEm = "Desentupidora em Amador Bueno";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-amador-bueno";
