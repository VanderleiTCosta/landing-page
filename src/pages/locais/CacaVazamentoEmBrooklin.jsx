...
export default function CacaVazamentoEmBrooklin() {
  const bairro = "Brooklin";
  const zona = "Zona Sul";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento Brooklin";
  const keywordEm = "Caça Vazamento em Brooklin";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-brooklin";
