...
export default function EncanadorEmAbcPaulista() {
  const bairro = "ABC Paulista";
  const zona = "Outras Regiões";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador ABC Paulista";
  const keywordEm = "Encanador em ABC Paulista";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-abc-paulista";
