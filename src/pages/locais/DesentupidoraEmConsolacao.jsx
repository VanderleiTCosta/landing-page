...
export default function DesentupidoraEmConsolacao() {
  const bairro = "Consolação";
  const zona = "Centro de São Paulo";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Consolação";
  const keywordEm = "Desentupidora em Consolação";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-consolacao";
