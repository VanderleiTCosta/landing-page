...
export default function LimpaFossaEmAltoDaBoaVista() {
  const bairro = "Alto da Boa Vista";
  const zona = "Zona Sul";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Alto da Boa Vista";
  const keywordEm = "Limpa Fossa em Alto da Boa Vista";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-alto-da-boa-vista";
