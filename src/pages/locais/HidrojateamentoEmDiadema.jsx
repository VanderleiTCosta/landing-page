...
export default function HidrojateamentoEmDiadema() {
  const bairro = "Diadema";
  const zona = "Outras Regiões";
  const servico = "Hidrojateamento";
  
  const tituloPagina = "Hidrojateamento Diadema";
  const keywordEm = "Hidrojateamento em Diadema";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/hidrojateamento-em-diadema";
