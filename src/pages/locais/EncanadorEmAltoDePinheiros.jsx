...
export default function EncanadorEmAltoDePinheiros() {
  const bairro = "Alto de Pinheiros";
  const zona = "Zona Oeste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Alto de Pinheiros";
  const keywordEm = "Encanador em Alto de Pinheiros";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-alto-de-pinheiros";
