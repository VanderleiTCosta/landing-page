...
export default function CacaVazamentoEmDiadema() {
  const bairro = "Diadema";
  const zona = "Outras Regiões";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento Diadema";
  const keywordEm = "Caça Vazamento em Diadema";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-diadema";
