...
export default function LimpaFossaEmArthurAlvim() {
  const bairro = "Arthur Alvim";
  const zona = "Zona Leste";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Arthur Alvim";
  const keywordEm = "Limpa Fossa em Arthur Alvim";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-arthur-alvim";
