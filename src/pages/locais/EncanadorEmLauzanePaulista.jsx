...
export default function EncanadorEmLauzanePaulista() {
  const bairro = "Lauzane Paulista";
  const zona = "Zona Norte";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Lauzane Paulista";
  const keywordEm = "Encanador em Lauzane Paulista";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-lauzane-paulista";
