...
export default function DesentupidoraEmCotia() {
  const bairro = "Cotia";
  const zona = "Zona Oeste";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Cotia";
  const keywordEm = "Desentupidora em Cotia";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-cotia";
