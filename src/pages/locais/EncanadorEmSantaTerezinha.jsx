...
export default function EncanadorEmSantaTerezinha() {
  const bairro = "Santa Terezinha";
  const zona = "Zona Norte";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Santa Terezinha";
  const keywordEm = "Encanador em Santa Terezinha";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-santa-terezinha";
