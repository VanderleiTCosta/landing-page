...
export default function DesentupidoraEmCasaVerde() {
  const bairro = "Casa Verde";
  const zona = "Zona Norte";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Casa Verde";
  const keywordEm = "Desentupidora em Casa Verde";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-casa-verde";
