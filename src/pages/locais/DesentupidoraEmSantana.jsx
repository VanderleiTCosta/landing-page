...
export default function DesentupidoraEmSantana() {
  const bairro = "Santana";
  const zona = "Zona Norte";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Santana";
  const keywordEm = "Desentupidora em Santana";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-santana";
