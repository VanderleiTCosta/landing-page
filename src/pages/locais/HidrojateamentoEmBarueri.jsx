...
export default function HidrojateamentoEmBarueri() {
  const bairro = "Barueri";
  const zona = "Zona Oeste";
  const servico = "Hidrojateamento";
  
  const tituloPagina = "Hidrojateamento Barueri";
  const keywordEm = "Hidrojateamento em Barueri";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/hidrojateamento-em-barueri";
