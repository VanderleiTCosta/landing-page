...
export default function LimpaFossaEmCapelaDoSocorro() {
  const bairro = "Capela do Socorro";
  const zona = "Zona Sul";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Capela do Socorro";
  const keywordEm = "Limpa Fossa em Capela do Socorro";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-capela-do-socorro";
