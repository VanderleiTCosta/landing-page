...
export default function DesentupidoraEmButanta() {
  const bairro = "Butantã";
  const zona = "Zona Oeste";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Butantã";
  const keywordEm = "Desentupidora em Butantã";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-butanta";
