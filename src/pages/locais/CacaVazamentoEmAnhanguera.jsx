...
export default function CacaVazamentoEmAnhanguera() {
  const bairro = "Anhanguera";
  const zona = "Centro de São Paulo";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento Anhanguera";
  const keywordEm = "Caça Vazamento em Anhanguera";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-anhanguera";
