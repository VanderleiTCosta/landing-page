...
export default function CacaVazamentoEmArthurAlvim() {
  const bairro = "Arthur Alvim";
  const zona = "Zona Leste";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento Arthur Alvim";
  const keywordEm = "Caça Vazamento em Arthur Alvim";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-arthur-alvim";
