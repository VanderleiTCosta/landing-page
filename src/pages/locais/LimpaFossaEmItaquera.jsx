...
export default function LimpaFossaEmItaquera() {
  const bairro = "Itaquera";
  const zona = "Zona Leste";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Itaquera";
  const keywordEm = "Limpa Fossa em Itaquera";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-itaquera";
