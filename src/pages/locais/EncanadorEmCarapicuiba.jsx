...
export default function EncanadorEmCarapicuiba() {
  const bairro = "Carapicuiba";
  const zona = "Zona Oeste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Carapicuiba";
  const keywordEm = "Encanador em Carapicuiba";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-carapicuiba";
