...
export default function EncanadorEmJardins() {
  const bairro = "Jardins";
  const zona = "Centro de São Paulo";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Jardins";
  const keywordEm = "Encanador em Jardins";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-jardins";
