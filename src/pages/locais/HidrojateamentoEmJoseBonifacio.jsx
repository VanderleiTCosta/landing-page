...
export default function HidrojateamentoEmJoseBonifacio() {
  const bairro = "José Bonifácio";
  const zona = "Zona Norte";
  const servico = "Hidrojateamento";
  
  const tituloPagina = "Hidrojateamento José Bonifácio";
  const keywordEm = "Hidrojateamento em José Bonifácio";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/hidrojateamento-em-jose-bonifacio";
