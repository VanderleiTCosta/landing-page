...
export default function EncanadorEmBarraFunda() {
  const bairro = "Barra Funda";
  const zona = "Zona Oeste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Barra Funda";
  const keywordEm = "Encanador em Barra Funda";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-barra-funda";
