...
export default function EncanadorEmBairroDoLimao() {
  const bairro = "Bairro do Limão";
  const zona = "Zona Norte";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Bairro do Limão";
  const keywordEm = "Encanador em Bairro do Limão";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-bairro-do-limao";
