...
export default function CacaVazamentoEmAmericanopolis() {
  const bairro = "Americanópolis";
  const zona = "Zona Leste";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento Americanópolis";
  const keywordEm = "Caça Vazamento em Americanópolis";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-americanopolis";
