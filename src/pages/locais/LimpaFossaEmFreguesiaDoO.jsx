...
export default function LimpaFossaEmFreguesiaDoO() {
  const bairro = "Freguesia do Ó";
  const zona = "Zona Norte";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Freguesia do Ó";
  const keywordEm = "Limpa Fossa em Freguesia do Ó";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-freguesia-do-o";
