...
export default function EncanadorEmBras() {
  const bairro = "Brás";
  const zona = "Centro de São Paulo";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Brás";
  const keywordEm = "Encanador em Brás";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-bras";
