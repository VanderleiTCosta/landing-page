...
export default function DesentupidoraEmItapevi() {
  const bairro = "Itapevi";
  const zona = "Zona Oeste";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Itapevi";
  const keywordEm = "Desentupidora em Itapevi";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-itapevi";
