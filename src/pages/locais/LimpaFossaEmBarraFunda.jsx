...
export default function LimpaFossaEmBarraFunda() {
  const bairro = "Barra Funda";
  const zona = "Zona Oeste";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Barra Funda";
  const keywordEm = "Limpa Fossa em Barra Funda";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-barra-funda";
