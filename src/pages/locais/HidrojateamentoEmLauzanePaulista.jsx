...
export default function HidrojateamentoEmLauzanePaulista() {
  const bairro = "Lauzane Paulista";
  const zona = "Zona Norte";
  const servico = "Hidrojateamento";
  
  const tituloPagina = "Hidrojateamento Lauzane Paulista";
  const keywordEm = "Hidrojateamento em Lauzane Paulista";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/hidrojateamento-em-lauzane-paulista";
