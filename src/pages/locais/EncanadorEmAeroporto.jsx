...
export default function EncanadorEmAeroporto() {
  const bairro = "Aeroporto";
  const zona = "Outras Regiões";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Aeroporto";
  const keywordEm = "Encanador em Aeroporto";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-aeroporto";
