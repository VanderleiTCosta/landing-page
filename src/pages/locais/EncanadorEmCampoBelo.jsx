...
export default function EncanadorEmCampoBelo() {
  const bairro = "Campo Belo";
  const zona = "Zona Sul";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Campo Belo";
  const keywordEm = "Encanador em Campo Belo";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-campo-belo";
