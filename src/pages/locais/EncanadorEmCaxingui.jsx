...
export default function EncanadorEmCaxingui() {
  const bairro = "Caxingui";
  const zona = "Zona Oeste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Caxingui";
  const keywordEm = "Encanador em Caxingui";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-caxingui";
