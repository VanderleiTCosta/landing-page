...
export default function CacaVazamentoEmAvenidaPaulista() {
  const bairro = "Avenida Paulista";
  const zona = "Centro de São Paulo";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento Avenida Paulista";
  const keywordEm = "Caça Vazamento em Avenida Paulista";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-avenida-paulista";
