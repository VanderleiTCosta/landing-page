...
export default function EncanadorEmCidadePatriarca() {
  const bairro = "Cidade Patriarca";
  const zona = "Zona Leste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Cidade Patriarca";
  const keywordEm = "Encanador em Cidade Patriarca";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-cidade-patriarca";
