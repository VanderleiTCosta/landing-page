...
export default function EncanadorEmAvenidaPaulista() {
  const bairro = "Avenida Paulista";
  const zona = "Centro de São Paulo";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Avenida Paulista";
  const keywordEm = "Encanador em Avenida Paulista";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-avenida-paulista";
