...
export default function EncanadorEmCampoLimpo() {
  const bairro = "Campo Limpo";
  const zona = "Zona Sul";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Campo Limpo";
  const keywordEm = "Encanador em Campo Limpo";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-campo-limpo";
