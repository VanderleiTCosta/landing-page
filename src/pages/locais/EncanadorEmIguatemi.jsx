...
export default function EncanadorEmIguatemi() {
  const bairro = "Iguatemi";
  const zona = "Zona Leste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Iguatemi";
  const keywordEm = "Encanador em Iguatemi";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-iguatemi";
