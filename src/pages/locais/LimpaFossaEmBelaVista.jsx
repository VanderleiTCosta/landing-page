...
export default function LimpaFossaEmBelaVista() {
  const bairro = "Bela Vista";
  const zona = "Centro de São Paulo";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Bela Vista";
  const keywordEm = "Limpa Fossa em Bela Vista";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-bela-vista";
