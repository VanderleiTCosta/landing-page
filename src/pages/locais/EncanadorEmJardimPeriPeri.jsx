...
export default function EncanadorEmJardimPeriPeri() {
  const bairro = "Jardim Peri Peri";
  const zona = "Zona Norte";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Jardim Peri Peri";
  const keywordEm = "Encanador em Jardim Peri Peri";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-jardim-peri-peri";
