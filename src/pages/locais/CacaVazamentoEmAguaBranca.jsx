...
export default function CacaVazamentoEmAguaBranca() {
  const bairro = "Água Branca";
  const zona = "Zona Oeste";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento Água Branca";
  const keywordEm = "Caça Vazamento em Água Branca";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-agua-branca";
