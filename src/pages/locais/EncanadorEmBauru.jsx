...
export default function EncanadorEmBauru() {
  const bairro = "Bauru";
  const zona = "Outras Regiões";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Bauru";
  const keywordEm = "Encanador em Bauru";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-bauru";
