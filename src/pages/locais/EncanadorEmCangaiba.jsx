...
export default function EncanadorEmCangaiba() {
  const bairro = "Cangaiba";
  const zona = "Zona Leste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Cangaiba";
  const keywordEm = "Encanador em Cangaiba";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-cangaiba";
