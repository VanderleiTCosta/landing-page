...
export default function EncanadorEmDiadema() {
  const bairro = "Diadema";
  const zona = "Outras Regiões";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Diadema";
  const keywordEm = "Encanador em Diadema";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-diadema";
