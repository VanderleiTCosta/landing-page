...
export default function EncanadorEmCapaoRedondo() {
  const bairro = "Capão Redondo";
  const zona = "Zona Sul";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Capão Redondo";
  const keywordEm = "Encanador em Capão Redondo";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-capao-redondo";
