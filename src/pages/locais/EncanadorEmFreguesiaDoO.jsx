...
export default function EncanadorEmFreguesiaDoO() {
  const bairro = "Freguesia do Ó";
  const zona = "Zona Norte";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Freguesia do Ó";
  const keywordEm = "Encanador em Freguesia do Ó";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-freguesia-do-o";
