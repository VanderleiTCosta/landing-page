...
export default function HidrojateamentoEmCapaoRedondo() {
  const bairro = "Capão Redondo";
  const zona = "Zona Sul";
  const servico = "Hidrojateamento";
  
  const tituloPagina = "Hidrojateamento Capão Redondo";
  const keywordEm = "Hidrojateamento em Capão Redondo";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/hidrojateamento-em-capao-redondo";
