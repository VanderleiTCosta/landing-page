...
export default function EncanadorEmGranjaViana() {
  const bairro = "Granja Viana";
  const zona = "Zona Oeste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Granja Viana";
  const keywordEm = "Encanador em Granja Viana";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-granja-viana";
