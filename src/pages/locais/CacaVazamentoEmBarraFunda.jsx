...
export default function CacaVazamentoEmBarraFunda() {
  const bairro = "Barra Funda";
  const zona = "Zona Oeste";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento Barra Funda";
  const keywordEm = "Caça Vazamento em Barra Funda";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-barra-funda";
