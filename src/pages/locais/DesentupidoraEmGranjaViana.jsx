...
export default function DesentupidoraEmGranjaViana() {
  const bairro = "Granja Viana";
  const zona = "Zona Oeste";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Granja Viana";
  const keywordEm = "Desentupidora em Granja Viana";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-granja-viana";
