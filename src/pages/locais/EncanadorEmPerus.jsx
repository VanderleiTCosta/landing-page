...
export default function EncanadorEmPerus() {
  const bairro = "Perus";
  const zona = "Zona Norte";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Perus";
  const keywordEm = "Encanador em Perus";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-perus";
