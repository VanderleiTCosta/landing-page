...
export default function LimpaFossaEmBrasilandia() {
  const bairro = "Brasilândia";
  const zona = "Zona Norte";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Brasilândia";
  const keywordEm = "Limpa Fossa em Brasilândia";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-brasilandia";
