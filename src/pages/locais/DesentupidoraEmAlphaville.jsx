...
export default function DesentupidoraEmAlphaville() {
  const bairro = "Alphaville";
  const zona = "Zona Oeste";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Alphaville";
  const keywordEm = "Desentupidora em Alphaville";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-alphaville";
