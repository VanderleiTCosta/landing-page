...
export default function EncanadorEmCasaVerde() {
  const bairro = "Casa Verde";
  const zona = "Zona Norte";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Casa Verde";
  const keywordEm = "Encanador em Casa Verde";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-casa-verde";
