...
export default function EncanadorEmAnhanguera() {
  const bairro = "Anhanguera";
  const zona = "Centro de São Paulo";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Anhanguera";
  const keywordEm = "Encanador em Anhanguera";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-anhanguera";
