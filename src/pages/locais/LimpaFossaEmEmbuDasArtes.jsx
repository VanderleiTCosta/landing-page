...
export default function LimpaFossaEmEmbuDasArtes() {
  const bairro = "Embu das Artes";
  const zona = "Zona Oeste";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Embu das Artes";
  const keywordEm = "Limpa Fossa em Embu das Artes";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-embu-das-artes";
