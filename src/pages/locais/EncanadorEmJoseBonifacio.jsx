...
export default function EncanadorEmJoseBonifacio() {
  const bairro = "José Bonifácio";
  const zona = "Zona Norte";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador José Bonifácio";
  const keywordEm = "Encanador em José Bonifácio";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-jose-bonifacio";
