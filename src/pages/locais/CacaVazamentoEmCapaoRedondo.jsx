...
export default function CacaVazamentoEmCapaoRedondo() {
  const bairro = "Capão Redondo";
  const zona = "Zona Sul";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento Capão Redondo";
  const keywordEm = "Caça Vazamento em Capão Redondo";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-capao-redondo";
