...
export default function CacaVazamentoEmBarueri() {
  const bairro = "Barueri";
  const zona = "Zona Oeste";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento Barueri";
  const keywordEm = "Caça Vazamento em Barueri";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-barueri";
