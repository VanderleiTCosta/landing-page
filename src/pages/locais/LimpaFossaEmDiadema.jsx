...
export default function LimpaFossaEmDiadema() {
  const bairro = "Diadema";
  const zona = "Outras Regiões";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Diadema";
  const keywordEm = "Limpa Fossa em Diadema";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-diadema";
