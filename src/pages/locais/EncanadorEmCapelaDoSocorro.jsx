...
export default function EncanadorEmCapelaDoSocorro() {
  const bairro = "Capela do Socorro";
  const zona = "Zona Sul";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Capela do Socorro";
  const keywordEm = "Encanador em Capela do Socorro";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-capela-do-socorro";
