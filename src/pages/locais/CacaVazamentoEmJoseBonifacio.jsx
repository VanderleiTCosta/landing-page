...
export default function CacaVazamentoEmJoseBonifacio() {
  const bairro = "José Bonifácio";
  const zona = "Zona Norte";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento José Bonifácio";
  const keywordEm = "Caça Vazamento em José Bonifácio";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-jose-bonifacio";
