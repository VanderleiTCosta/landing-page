...
export default function HidrojateamentoEmErmelinoMatarazzo() {
  const bairro = "Ermelino Matarazzo";
  const zona = "Zona Leste";
  const servico = "Hidrojateamento";
  
  const tituloPagina = "Hidrojateamento Ermelino Matarazzo";
  const keywordEm = "Hidrojateamento em Ermelino Matarazzo";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/hidrojateamento-em-ermelino-matarazzo";
