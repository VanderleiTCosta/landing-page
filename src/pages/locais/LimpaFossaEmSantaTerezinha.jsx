...
export default function LimpaFossaEmSantaTerezinha() {
  const bairro = "Santa Terezinha";
  const zona = "Zona Norte";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Santa Terezinha";
  const keywordEm = "Limpa Fossa em Santa Terezinha";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-santa-terezinha";
