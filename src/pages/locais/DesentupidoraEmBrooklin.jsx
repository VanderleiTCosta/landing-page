...
export default function DesentupidoraEmBrooklin() {
  const bairro = "Brooklin";
  const zona = "Zona Sul";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Brooklin";
  const keywordEm = "Desentupidora em Brooklin";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-brooklin";
