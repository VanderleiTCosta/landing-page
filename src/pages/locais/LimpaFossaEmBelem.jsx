...
export default function LimpaFossaEmBelem() {
  const bairro = "Belém";
  const zona = "Zona Leste";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Belém";
  const keywordEm = "Limpa Fossa em Belém";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-belem";
