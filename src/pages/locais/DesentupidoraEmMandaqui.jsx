...
export default function DesentupidoraEmMandaqui() {
  const bairro = "Mandaqui";
  const zona = "Zona Norte";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Mandaqui";
  const keywordEm = "Desentupidora em Mandaqui";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-mandaqui";
