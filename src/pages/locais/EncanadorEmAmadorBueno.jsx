...
export default function EncanadorEmAmadorBueno() {
  const bairro = "Amador Bueno";
  const zona = "Zona Oeste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Amador Bueno";
  const keywordEm = "Encanador em Amador Bueno";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-amador-bueno";
