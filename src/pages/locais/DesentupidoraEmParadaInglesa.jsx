...
export default function DesentupidoraEmParadaInglesa() {
  const bairro = "Parada Inglesa";
  const zona = "Zona Norte";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Parada Inglesa";
  const keywordEm = "Desentupidora em Parada Inglesa";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-parada-inglesa";
