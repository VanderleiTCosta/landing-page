...
export default function LimpaFossaEmAnhanguera() {
  const bairro = "Anhanguera";
  const zona = "Centro de São Paulo";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Anhanguera";
  const keywordEm = "Limpa Fossa em Anhanguera";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-anhanguera";
