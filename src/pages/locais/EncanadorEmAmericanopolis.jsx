...
export default function EncanadorEmAmericanopolis() {
  const bairro = "Americanópolis";
  const zona = "Zona Leste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Americanópolis";
  const keywordEm = "Encanador em Americanópolis";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-americanopolis";
