...
export default function LimpaFossaEmAmadorBueno() {
  const bairro = "Amador Bueno";
  const zona = "Zona Oeste";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Amador Bueno";
  const keywordEm = "Limpa Fossa em Amador Bueno";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-amador-bueno";
