...
export default function LimpaFossaEmErmelinoMatarazzo() {
  const bairro = "Ermelino Matarazzo";
  const zona = "Zona Leste";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Ermelino Matarazzo";
  const keywordEm = "Limpa Fossa em Ermelino Matarazzo";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-ermelino-matarazzo";
