...
export default function EncanadorEmSantana() {
  const bairro = "Santana";
  const zona = "Zona Norte";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Santana";
  const keywordEm = "Encanador em Santana";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-santana";
