...
export default function DesentupidoraEmDiadema() {
  const bairro = "Diadema";
  const zona = "Outras Regiões";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Diadema";
  const keywordEm = "Desentupidora em Diadema";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-diadema";
