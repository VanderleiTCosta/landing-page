...
export default function CacaVazamentoEmCapelaDoSocorro() {
  const bairro = "Capela do Socorro";
  const zona = "Zona Sul";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento Capela do Socorro";
  const keywordEm = "Caça Vazamento em Capela do Socorro";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-capela-do-socorro";
