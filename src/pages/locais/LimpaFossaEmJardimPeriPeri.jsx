...
export default function LimpaFossaEmJardimPeriPeri() {
  const bairro = "Jardim Peri Peri";
  const zona = "Zona Norte";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Jardim Peri Peri";
  const keywordEm = "Limpa Fossa em Jardim Peri Peri";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-jardim-peri-peri";
