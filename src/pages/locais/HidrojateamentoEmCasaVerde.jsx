...
export default function HidrojateamentoEmCasaVerde() {
  const bairro = "Casa Verde";
  const zona = "Zona Norte";
  const servico = "Hidrojateamento";
  
  const tituloPagina = "Hidrojateamento Casa Verde";
  const keywordEm = "Hidrojateamento em Casa Verde";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/hidrojateamento-em-casa-verde";
