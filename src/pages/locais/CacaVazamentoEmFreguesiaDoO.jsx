...
export default function CacaVazamentoEmFreguesiaDoO() {
  const bairro = "Freguesia do Ó";
  const zona = "Zona Norte";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento Freguesia do Ó";
  const keywordEm = "Caça Vazamento em Freguesia do Ó";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-freguesia-do-o";
