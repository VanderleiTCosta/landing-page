...
export default function DesentupidoraEmEmbuDasArtes() {
  const bairro = "Embu das Artes";
  const zona = "Zona Oeste";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Embu das Artes";
  const keywordEm = "Desentupidora em Embu das Artes";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-embu-das-artes";
