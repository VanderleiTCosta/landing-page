...
export default function EncanadorEmBrasilandia() {
  const bairro = "Brasilândia";
  const zona = "Zona Norte";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Brasilândia";
  const keywordEm = "Encanador em Brasilândia";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-brasilandia";
