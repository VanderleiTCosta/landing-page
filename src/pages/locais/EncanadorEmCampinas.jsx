...
export default function EncanadorEmCampinas() {
  const bairro = "Campinas";
  const zona = "Outras Regiões";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Campinas";
  const keywordEm = "Encanador em Campinas";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-campinas";
