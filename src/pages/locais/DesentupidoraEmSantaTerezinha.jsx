...
export default function DesentupidoraEmSantaTerezinha() {
  const bairro = "Santa Terezinha";
  const zona = "Zona Norte";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Santa Terezinha";
  const keywordEm = "Desentupidora em Santa Terezinha";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-santa-terezinha";
