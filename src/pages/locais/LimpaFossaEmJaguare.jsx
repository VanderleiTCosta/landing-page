...
export default function LimpaFossaEmJaguare() {
  const bairro = "Jaguaré";
  const zona = "Zona Oeste";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Jaguaré";
  const keywordEm = "Limpa Fossa em Jaguaré";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-jaguare";
