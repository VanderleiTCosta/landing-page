...
export default function DesentupidoraEmCaxingui() {
  const bairro = "Caxingui";
  const zona = "Zona Oeste";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Caxingui";
  const keywordEm = "Desentupidora em Caxingui";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-caxingui";
