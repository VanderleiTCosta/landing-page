...
export default function DesentupidoraEmBomRetiro() {
  const bairro = "Bom Retiro";
  const zona = "Centro de São Paulo";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Bom Retiro";
  const keywordEm = "Desentupidora em Bom Retiro";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-bom-retiro";
