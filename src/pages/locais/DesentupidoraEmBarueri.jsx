...
export default function DesentupidoraEmBarueri() {
  const bairro = "Barueri";
  const zona = "Zona Oeste";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Barueri";
  const keywordEm = "Desentupidora em Barueri";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-barueri";
