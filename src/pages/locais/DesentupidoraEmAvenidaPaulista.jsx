...
export default function DesentupidoraEmAvenidaPaulista() {
  const bairro = "Avenida Paulista";
  const zona = "Centro de São Paulo";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Avenida Paulista";
  const keywordEm = "Desentupidora em Avenida Paulista";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-avenida-paulista";
