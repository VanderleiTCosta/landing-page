...
export default function LimpaFossaEmAvenidaPaulista() {
  const bairro = "Avenida Paulista";
  const zona = "Centro de São Paulo";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Avenida Paulista";
  const keywordEm = "Limpa Fossa em Avenida Paulista";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-avenida-paulista";
