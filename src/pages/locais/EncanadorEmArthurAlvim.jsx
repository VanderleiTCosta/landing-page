...
export default function EncanadorEmArthurAlvim() {
  const bairro = "Arthur Alvim";
  const zona = "Zona Leste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Arthur Alvim";
  const keywordEm = "Encanador em Arthur Alvim";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-arthur-alvim";
