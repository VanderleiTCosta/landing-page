...
export default function CacaVazamentoEmSantaTerezinha() {
  const bairro = "Santa Terezinha";
  const zona = "Zona Norte";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento Santa Terezinha";
  const keywordEm = "Caça Vazamento em Santa Terezinha";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-santa-terezinha";
