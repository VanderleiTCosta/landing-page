...
export default function HidrojateamentoEmSantaTerezinha() {
  const bairro = "Santa Terezinha";
  const zona = "Zona Norte";
  const servico = "Hidrojateamento";
  
  const tituloPagina = "Hidrojateamento Santa Terezinha";
  const keywordEm = "Hidrojateamento em Santa Terezinha";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/hidrojateamento-em-santa-terezinha";
