...
export default function LimpaFossaEmCidadeTiradentes() {
  const bairro = "Cidade Tiradentes";
  const zona = "Zona Leste";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Cidade Tiradentes";
  const keywordEm = "Limpa Fossa em Cidade Tiradentes";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-cidade-tiradentes";
