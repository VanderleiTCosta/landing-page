...
export default function EncanadorEmItaimPaulista() {
  const bairro = "Itaim Paulista";
  const zona = "Zona Leste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Itaim Paulista";
  const keywordEm = "Encanador em Itaim Paulista";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-itaim-paulista";
