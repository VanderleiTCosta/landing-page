...
export default function HidrojateamentoEmCidadePatriarca() {
  const bairro = "Cidade Patriarca";
  const zona = "Zona Leste";
  const servico = "Hidrojateamento";
  
  const tituloPagina = "Hidrojateamento Cidade Patriarca";
  const keywordEm = "Hidrojateamento em Cidade Patriarca";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/hidrojateamento-em-cidade-patriarca";
