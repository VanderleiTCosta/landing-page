...
export default function EncanadorEmPacaembu() {
  const bairro = "Pacaembu";
  const zona = "Centro de São Paulo";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Pacaembu";
  const keywordEm = "Encanador em Pacaembu";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-pacaembu";
