...
export default function EncanadorEmBarueri() {
  const bairro = "Barueri";
  const zona = "Zona Oeste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Barueri";
  const keywordEm = "Encanador em Barueri";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-barueri";
