...
export default function DesentupidoraEmSantaEfigenia() {
  const bairro = "Santa Efigênia";
  const zona = "Centro de São Paulo";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Santa Efigênia";
  const keywordEm = "Desentupidora em Santa Efigênia";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-santa-efigenia";
