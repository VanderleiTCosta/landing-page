...
export default function DesentupidoraEmArthurAlvim() {
  const bairro = "Arthur Alvim";
  const zona = "Zona Leste";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Arthur Alvim";
  const keywordEm = "Desentupidora em Arthur Alvim";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-arthur-alvim";
