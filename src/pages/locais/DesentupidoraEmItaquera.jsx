...
export default function DesentupidoraEmItaquera() {
  const bairro = "Itaquera";
  const zona = "Zona Leste";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Itaquera";
  const keywordEm = "Desentupidora em Itaquera";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-itaquera";
