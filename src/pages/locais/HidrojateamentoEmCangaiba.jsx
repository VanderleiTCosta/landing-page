...
export default function HidrojateamentoEmCangaiba() {
  const bairro = "Cangaiba";
  const zona = "Zona Leste";
  const servico = "Hidrojateamento";
  
  const tituloPagina = "Hidrojateamento Cangaiba";
  const keywordEm = "Hidrojateamento em Cangaiba";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/hidrojateamento-em-cangaiba";
