...
export default function LimpaFossaEmCangaiba() {
  const bairro = "Cangaiba";
  const zona = "Zona Leste";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Cangaiba";
  const keywordEm = "Limpa Fossa em Cangaiba";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-cangaiba";
