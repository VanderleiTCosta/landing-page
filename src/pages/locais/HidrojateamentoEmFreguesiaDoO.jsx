...
export default function HidrojateamentoEmFreguesiaDoO() {
  const bairro = "Freguesia do Ó";
  const zona = "Zona Norte";
  const servico = "Hidrojateamento";
  
  const tituloPagina = "Hidrojateamento Freguesia do Ó";
  const keywordEm = "Hidrojateamento em Freguesia do Ó";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/hidrojateamento-em-freguesia-do-o";
