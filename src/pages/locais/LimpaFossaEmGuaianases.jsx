...
export default function LimpaFossaEmGuaianases() {
  const bairro = "Guaianases";
  const zona = "Zona Leste";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Guaianases";
  const keywordEm = "Limpa Fossa em Guaianases";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-guaianases";
