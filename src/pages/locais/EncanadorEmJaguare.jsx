...
export default function EncanadorEmJaguare() {
  const bairro = "Jaguaré";
  const zona = "Zona Oeste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Jaguaré";
  const keywordEm = "Encanador em Jaguaré";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-jaguare";
