...
export default function EncanadorEmEmbuDasArtes() {
  const bairro = "Embu das Artes";
  const zona = "Zona Oeste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Embu das Artes";
  const keywordEm = "Encanador em Embu das Artes";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-embu-das-artes";
