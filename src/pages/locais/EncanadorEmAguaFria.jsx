...
export default function EncanadorEmAguaFria() {
  const bairro = "Água Fria";
  const zona = "Zona Norte";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Água Fria";
  const keywordEm = "Encanador em Água Fria";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-agua-fria";
