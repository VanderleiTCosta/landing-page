...
export default function LimpaFossaEmPacaembu() {
  const bairro = "Pacaembu";
  const zona = "Centro de São Paulo";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Pacaembu";
  const keywordEm = "Limpa Fossa em Pacaembu";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-pacaembu";
