...
export default function EncanadorEmJandira() {
  const bairro = "Jandira";
  const zona = "Zona Oeste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Jandira";
  const keywordEm = "Encanador em Jandira";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-jandira";
