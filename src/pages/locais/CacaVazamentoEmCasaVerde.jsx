...
export default function CacaVazamentoEmCasaVerde() {
  const bairro = "Casa Verde";
  const zona = "Zona Norte";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento Casa Verde";
  const keywordEm = "Caça Vazamento em Casa Verde";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-casa-verde";
