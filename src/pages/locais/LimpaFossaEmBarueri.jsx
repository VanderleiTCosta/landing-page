...
export default function LimpaFossaEmBarueri() {
  const bairro = "Barueri";
  const zona = "Zona Oeste";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Barueri";
  const keywordEm = "Limpa Fossa em Barueri";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-barueri";
