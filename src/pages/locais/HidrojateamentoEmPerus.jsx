...
export default function HidrojateamentoEmPerus() {
  const bairro = "Perus";
  const zona = "Zona Norte";
  const servico = "Hidrojateamento";
  
  const tituloPagina = "Hidrojateamento Perus";
  const keywordEm = "Hidrojateamento em Perus";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/hidrojateamento-em-perus";
