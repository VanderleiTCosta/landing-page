...
export default function DesentupidoraEmJoseBonifacio() {
  const bairro = "José Bonifácio";
  const zona = "Zona Norte";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora José Bonifácio";
  const keywordEm = "Desentupidora em José Bonifácio";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-jose-bonifacio";
