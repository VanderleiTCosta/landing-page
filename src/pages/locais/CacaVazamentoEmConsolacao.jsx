...
export default function CacaVazamentoEmConsolacao() {
  const bairro = "Consolação";
  const zona = "Centro de São Paulo";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento Consolação";
  const keywordEm = "Caça Vazamento em Consolação";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-consolacao";
