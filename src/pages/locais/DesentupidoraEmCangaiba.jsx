...
export default function DesentupidoraEmCangaiba() {
  const bairro = "Cangaiba";
  const zona = "Zona Leste";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Cangaiba";
  const keywordEm = "Desentupidora em Cangaiba";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-cangaiba";
