...
export default function DesentupidoraEmCapelaDoSocorro() {
  const bairro = "Capela do Socorro";
  const zona = "Zona Sul";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Capela do Socorro";
  const keywordEm = "Desentupidora em Capela do Socorro";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-capela-do-socorro";
