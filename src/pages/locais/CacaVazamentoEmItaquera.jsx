...
export default function CacaVazamentoEmItaquera() {
  const bairro = "Itaquera";
  const zona = "Zona Leste";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento Itaquera";
  const keywordEm = "Caça Vazamento em Itaquera";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-itaquera";
