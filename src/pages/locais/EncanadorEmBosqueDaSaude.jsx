...
export default function EncanadorEmBosqueDaSaude() {
  const bairro = "Bosque da Saúde";
  const zona = "Zona Sul";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Bosque da Saúde";
  const keywordEm = "Encanador em Bosque da Saúde";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-bosque-da-saude";
