...
export default function LimpaFossaEmCasaVerde() {
  const bairro = "Casa Verde";
  const zona = "Zona Norte";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Casa Verde";
  const keywordEm = "Limpa Fossa em Casa Verde";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-casa-verde";
