...
export default function EncanadorEmGuaianases() {
  const bairro = "Guaianases";
  const zona = "Zona Leste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Guaianases";
  const keywordEm = "Encanador em Guaianases";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-guaianases";
