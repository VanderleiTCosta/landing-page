...
export default function EncanadorEmRepublica() {
  const bairro = "República";
  const zona = "Centro de São Paulo";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador República";
  const keywordEm = "Encanador em República";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-republica";
