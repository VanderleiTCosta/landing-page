...
export default function LimpaFossaEmCaxingui() {
  const bairro = "Caxingui";
  const zona = "Zona Oeste";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Caxingui";
  const keywordEm = "Limpa Fossa em Caxingui";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-caxingui";
