...
export default function DesentupidoraEmBarraFunda() {
  const bairro = "Barra Funda";
  const zona = "Zona Oeste";
  const servico = "Desentupidora";
  
  const tituloPagina = "Desentupidora Barra Funda";
  const keywordEm = "Desentupidora em Barra Funda";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/desentupidora-em-barra-funda";
