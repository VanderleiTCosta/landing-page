...
export default function LimpaFossaEmLauzanePaulista() {
  const bairro = "Lauzane Paulista";
  const zona = "Zona Norte";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Lauzane Paulista";
  const keywordEm = "Limpa Fossa em Lauzane Paulista";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-lauzane-paulista";
