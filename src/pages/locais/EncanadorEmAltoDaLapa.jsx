...
export default function EncanadorEmAltoDaLapa() {
  const bairro = "Alto da Lapa";
  const zona = "Zona Oeste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Alto da Lapa";
  const keywordEm = "Encanador em Alto da Lapa";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-alto-da-lapa";
