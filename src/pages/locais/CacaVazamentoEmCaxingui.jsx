...
export default function CacaVazamentoEmCaxingui() {
  const bairro = "Caxingui";
  const zona = "Zona Oeste";
  const servico = "Caça Vazamento";
  
  const tituloPagina = "Caça Vazamento Caxingui";
  const keywordEm = "Caça Vazamento em Caxingui";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/caca-vazamento-em-caxingui";
