...
export default function LimpaFossaEmGranjaViana() {
  const bairro = "Granja Viana";
  const zona = "Zona Oeste";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Granja Viana";
  const keywordEm = "Limpa Fossa em Granja Viana";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-granja-viana";
