...
export default function EncanadorEmParadaInglesa() {
  const bairro = "Parada Inglesa";
  const zona = "Zona Norte";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Parada Inglesa";
  const keywordEm = "Encanador em Parada Inglesa";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-parada-inglesa";
