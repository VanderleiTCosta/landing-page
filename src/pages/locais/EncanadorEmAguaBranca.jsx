...
export default function EncanadorEmAguaBranca() {
  const bairro = "Água Branca";
  const zona = "Zona Oeste";
  const servico = "Encanador";
  
  const tituloPagina = "Encanador Água Branca";
  const keywordEm = "Encanador em Água Branca";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/encanador-em-agua-branca";
