...
export default function LimpaFossaEmParadaInglesa() {
  const bairro = "Parada Inglesa";
  const zona = "Zona Norte";
  const servico = "Limpa Fossa";
  
  const tituloPagina = "Limpa Fossa Parada Inglesa";
  const keywordEm = "Limpa Fossa em Parada Inglesa";
  const urlLocal = "https://www.desentupidoranomorumbi.com.br/servicos/limpa-fossa-em-parada-inglesa";
